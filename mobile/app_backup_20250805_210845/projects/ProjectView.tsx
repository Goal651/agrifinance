...
import { Goal, GoalCreateRequest, GoalStatus, Project, TaskStatus } from '@/types';
...
export default function ProjectView() {
    ...
    const { currentProject, loading, setCurrentGoal } = useProject();
    ...
    return (
        <View className="flex-1 bg-white">
            ...
            <ScrollView className="p-4">
                {/* Project Header */}
                <View className="flex-row justify-between items-center mb-6">
                    <Text className="text-2xl font-bold flex-1">{currentProject.name}</Text>
                    <View
                        className="px-3 py-1 rounded-full"
                        style={{ backgroundColor: statusColors[currentProject.status as keyof typeof statusColors] }}
                    >
                ...
                <View className="mb-6">
                    ...
                    <Text className="text-gray-600">{currentProject.description || 'No description'}</Text>
                </View>
                ...
                <View className="mb-6">
                    ...
                    <View className="flex-row items-center mb-2">
                        ...
                        <Text className="text-gray-600 ml-2">
                            {currentProject.user?.firstName || 'Unknown'}
                        </Text>
                    </View>
